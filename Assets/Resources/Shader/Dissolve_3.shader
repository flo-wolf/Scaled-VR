Shader "Custom/Dissolve_3"
{
    ...
    SubShader
    {
		...
		half _Glossiness, _Metallic, _MinSize, _MaxSize;
        ...
        void surf (Input IN, inout SurfaceOutputStandard o)
        {
			...
			clip(distanceRight + noise);
			clip(distanceLeft + noise);
			clip(distanceFront + noise);
			clip(distanceBack + noise);
